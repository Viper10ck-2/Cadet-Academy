...
@section('title','Login')
@section('content')
<div class="flex-1 flex flex-col items-center justify-center p-6 navy-gradient overflow-y-auto">
    <div class="w-full max-w-sm">
        ...
        <form method="POST" action="{{ route('login', ['absen' => 1]) }}" class="space-y-4">
            @csrf
