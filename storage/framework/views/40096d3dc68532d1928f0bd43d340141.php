...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','Absensi'); ?> | Cadet Academy</title>
...
<nav class="bottom-nav">
    <div class="max-w-lg mx-auto flex items-center justify-around px-4">
        <a href="<?php echo e(route('absen.dashboard')); ?>" class="flex flex-col items-center gap-1 px-3 py-1 <?php echo e(request()->routeIs('absen.dashboard') ? 'text-[#D4A853]' : 'text-gray-400'); ?>">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
            <span class="text-[10px] font-medium">Home</span>
        </a>
        <a href="<?php echo e(route('absen.history')); ?>" class="flex flex-col items-center gap-1 px-3 py-1 <?php echo e(request()->routeIs('absen.history') ? 'text-[#D4A853]' : 'text-gray-400'); ?>">
        ...
        <a href="<?php echo e(route('absen.profile')); ?>" class="flex flex-col items-center gap-1 px-3 py-1 <?php echo e(request()->routeIs('absen.profile') ? 'text-[#D4A853]' : 'text-gray-400'); ?>">
...
<?php /**PATH E:\6. PROJECT\Cadet Academy\resources\views/layouts/absen.blade.php ENDPATH**/ ?>